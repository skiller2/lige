...
var flowRecibo = (0, bot_1.addKeyword)(bot_1.EVENTS.ACTION)
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, flowDynamic([{ body: "\u23F1\uFE0F Buscando recibos", delay: delay }])];
            case 1:
                _c.sent();
                myState = state.getMyState();
                personalId = myState.personalId;
                return [4 /*yield*/, controller_module_1.recibosController.getLastPeriodoOfComprobantes(personalId, 3).then(function (array) { return array; })];
            case 2:
    ...
    .addAction({ delay: delay }, function (_1, _a) { return __awaiter(void 0, [_1, _a], void 0, function (_, _b) {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.sent();
                return [4 /*yield*/, flowDynamic([{ body: 'Ingrese el número del período que desea descargar' }])];
            case 2:
                _c.sent();
                return [2 /*return*/];
        }
    ...
    var myState, periodosArray, msj, mes, anio, personalId, urlDocRecibo;
    var _c, _d;
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                personalId = myState.personalId;
                return [4 /*yield*/, controller_module_1.recibosController.getURLDocRecibo(personalId, anio, mes)];
            case 1:
                urlDocRecibo = _e.sent();
                if (!(urlDocRecibo instanceof Error)) return [3 /*break*/, 3];
                return [4 /*yield*/, flowDynamic([{ body: "Error, no se encontr\u00F3 el documento", delay: delay }])];
            case 2:
                _e.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, flowDynamic([{ body: "Recibo", media: urlDocRecibo, delay: delay }])
