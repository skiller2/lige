...
const routes: Routes = [{path: 'asistenciaexcepcion', component: ExcepcionAsistenciaComponent},{ path: 'ccfarm', component: GesCcfarmComponent }, { path: 'imgpers', component: ImgPersComponent}, { path: 'credpers', component: CredPersComponent},];
