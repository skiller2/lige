...
import { adelantosController } from "../controller/controller.module.ts";
...
adelantosRouter.post('', [authMiddleware.verifyToken, authMiddleware.hasGroup(['Liquidaciones','gConsejo','Responsables','Administrativo'])], (req, res, next) => {
...
adelantosRouter.post("/list", [authMiddleware.verifyToken, authMiddleware.hasGroup(['Liquidaciones', 'Liquidaciones Consultas','gConsejo','Responsables','Administrativo'])], (req, res, next) => {
