...
adelantosRouter.post('', [authMiddleware.verifyToken, authMiddleware.hasGroup(['Liquidaciones','gSistemas','gConsejo','Resonsables','Administrativo'])], (req, res, next) => {
...
adelantosRouter.delete('/:PersonalId', [authMiddleware.verifyToken, authMiddleware.hasGroup(['Liquidaciones','gSistemas','gConsejo','Resonsables','Administrativo'])], (req, res, next) => {
...
adelantosRouter.post("/list", [authMiddleware.verifyToken, authMiddleware.hasGroup(['Liquidaciones', 'Liquidaciones Consultas','gSistemas','gConsejo','Resonsables','Administrativo'])], (req, res, next) => {
