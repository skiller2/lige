...
export class DomicilioController extends BaseController {
  ...
  async getLocalidadId(queryRunner: QueryRunner, PaisId: number, ProvinciaId: number, LocalidadDescripcion1: string, LocalidadDescripcion2: string, LocalidadDescripcion3: string) {
    ...
    LocalidadDescripcion2 = limpiarLocalidad(LocalidadDescripcion2);
    LocalidadDescripcion3 = limpiarLocalidad(LocalidadDescripcion3);


    if (LocalidadDescripcion1 != '')
      LocalidadDescripcion1 = '%' + LocalidadDescripcion1
    if (LocalidadDescripcion2 != '')
      LocalidadDescripcion2 = '%' + LocalidadDescripcion2
    if (LocalidadDescripcion3 != '')
      LocalidadDescripcion3 = '%' + LocalidadDescripcion3
      ...
      for (const direccion of direcciones) {
        ...
        try {
          ...
          await queryRunner.query(`
                                    UPDATE Domicilio SET DomicilioJson = @1
                                    WHERE DomicilioId =@0
                                `, [DomicilioId, `ERROR ${error.message}`])
          continue
        }
