...
habilitacionesRouter.post('/listado', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gDireTec', 'gDirecTecCon'])], (req, res, next) => {
...
habilitacionesRouter.post('/personal', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gDireTec'])], (req, res, next) => {
