...
accesoBotRouter.get("/cols", [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal'])], (req, res) => {
  accesoBotController.getGridCols(req, res);
});

accesoBotRouter.post('/list', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal'])], (req, res, next) => {
  accesoBotController.list(req, res, next)
})

accesoBotRouter.get("/:PersonalId", [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal'])], (req, res, next) => {
  accesoBotController.getAccess(req, res, next);
});

accesoBotRouter.get("/dni/:PersonalId", [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal'])], (req, res, next) => {
  accesoBotController.getAccessDni(req, res, next);
});

accesoBotRouter.delete("/:PersonalId", [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal'])], (req, res, next) => {
  accesoBotController.deleteAccess(req, res, next);
});



accesoBotRouter.post("/filedni", [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal'])], (req, res, next) => {
  accesoBotController.getByDownloadFileDni(req, res, next);
});

accesoBotRouter.post('/', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal'])], (req, res, next) => {
  accesoBotController.updateAcess(req, res, next)
})

accesoBotRouter.post('/add', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal'])], (req, res, next) => {
