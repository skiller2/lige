...
import { segurosController } from "../controller/controller.module.ts";
...
segurosRouter.post(`/search`, [authMiddleware.verifyToken, authMiddleware.hasGroup(['gPersonal', 'gPersonalCon', 'Liquidaciones', 'Liquidaciones Consultas'])], (req, res, next) => {
