...
documentoRouter.get("/get/:id", [authMiddleware.verifyToken, authMiddleware.hasGroup(['gLegales', 'gLegalesCon', 'Liquidaciones', 'Liquidaciones Consultas','gSistemas', 'gPersonal', 'gPersonalCon'])], (req, res, next) => {
  documentoController.getDocumentoById(req, res, next);
});

documentoRouter.get("/cols", [
  authMiddleware.verifyToken,
  authMiddleware.hasGroup(['gLegales', 'gLegalesCon', 'Liquidaciones', 'Liquidaciones Consultas','gSistemas', 'gPersonal', 'gPersonalCon'])
], (req, res) => {
...
documentoRouter.post('/add', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gLegales', 'Liquidaciones', 'gSistemas', 'gPersonal']), authMiddleware.hasAuthByDocId()], (req, res, next) => {
  documentoController.addDocumento(req, res, next)
})

documentoRouter.post('/update', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gLegales', 'Liquidaciones', 'gSistemas', 'gPersonal']),  authMiddleware.hasAuthByDocId()], (req, res, next) => {
