...
parametrosVentaRouter.get('/infParametroVenta/:ClienteId/:ClienteElementoDependienteId/:PeriodoDesdeAplica', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gComercial', 'gComercialCon', 'Liquidaciones', 'Liquidaciones Consultas'])], (req, res, next) => {
...
parametrosVentaRouter.get('/mensaje-horas/:tipoHoras/:ClienteId/:ClienteElementoDependienteId/:anio/:mes', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gComercial', 'gComercialCon', 'Liquidaciones', 'Liquidaciones Consultas'])], (req, res, next) => {
