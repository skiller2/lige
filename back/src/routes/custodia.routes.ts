...
custodiaRouter.post('/setestado', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gCustodiasCon','gCustodias'])], (req, res, next) => { custodiaController.setEstados(req, res, next) } )
