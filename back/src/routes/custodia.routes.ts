...
custodiaRouter.post('/setestado', [authMiddleware.verifyToken, authMiddleware.hasGroup(['Adminitrativo'])], (req, res, next) => { custodiaController.setEstados(req, res, next) } )
