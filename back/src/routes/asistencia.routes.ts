...
import { asistenciaController } from "../controller/controller.module.ts"
...
asistenciaRouter.post('/perasist/:personalId', [authMiddleware.verifyToken, authMiddleware.hasGroup(['gOperaciones', 'gOperacionesCon'])], (req, res, next) => { asistenciaController.getPersonalAsistencia(req, res, next) })
...
asistenciaRouter.post('/periodo/inicio', [authMiddleware.verifyToken, authMiddleware.hasAuthObjetivo ,authMiddleware.hasGroup(['Liquidaciones'])], (req, res, next) => {asistenciaController.addAsistenciaPeriodoResJson(req, res, next)})
asistenciaRouter.get('/horasFacturacion/:anio/:mes/:ClienteId/:ClienteElementoDependienteId', authMiddleware.verifyToken, (req, res, next) => {asistenciaController.getHorasFacturacion(req, res, next)})
...
asistenciaRouter.post('/eliminarpersona', authMiddleware.verifyToken, (req, res, next) => { asistenciaController.eliminaCargaGrillaPersona(req, res, next) })
