...
export class AsistenciaController extends BaseController {
  ...
  (ROUND(CAST(licimp.PersonalLicenciaAplicaPeriodoHorasMensuales AS FLOAT) * 10, 0) / 10) as PersonalLicenciaAplicaPeriodoHorasMensuales,
  ...
  ROUND(CAST(licimp.PersonalLicenciaAplicaPeriodoHorasMensuales AS FLOAT) * val.ValorLiquidacionHoraNormal, 2) AS total,  
